...
public class AwtImage extends AbstractImage {
    ...
    // TODO: READ TILES FROM DIRECTORY
    // public static AwtImage readTiles() throws IOException { }

    @Override
    public int getRGB(int x, int y) { return bufferedImage.getRGB(x, y); }

    @Override
    public void setRGB(int x, int y, int rgb) { bufferedImage.setRGB(x, y, rgb); }
