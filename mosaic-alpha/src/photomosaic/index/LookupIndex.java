...
public class LookupIndex {
    ...
    public int getRed(int i) { return reds.get(order.get(i)); }

    public int getGreen(int i) { return greens.get(order.get(i)); }

    public int getBlue(int i) { return blues.get(order.get(i)); }
